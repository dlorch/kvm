...
export interface KeyboardLayout { isoCode: string, name: string, countryCode: number, chars: Record<string, KeyCombo> }
...
const keyboards: KeyboardLayout[] = [ cs_CZ, de_CH, de_DE, en_UK, en_US, es_ES, fr_BE, fr_CH, fr_FR, it_IT, nb_NO, sv_SE ];
